...
/**
 * This is the item provider adapter for a {@link no.hal.pgo.osm.Note} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NoteItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Note_contents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Note_contents_feature", "_UI_Note_type"),
				 OsmPackage.Literals.NOTE__CONTENTS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Note)object).getContents();
