...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>osm</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class OsmExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.osm"));
				Node root = OsmFactory.eINSTANCE.createNode();
