...
/**
 * This is the item provider adapter for a {@link no.hal.pgo.UoD} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UoDItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PgoPackage.Literals.UO_D__GAMES);
			childrenFeatures.add(PgoPackage.Literals.UO_D__PERSONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PgoPackage.Literals.UO_D__GAMES,
				 PgoFactory.eINSTANCE.createPGame()));

		newChildDescriptors.add
			(createChildParameter
				(PgoPackage.Literals.UO_D__PERSONS,
				 PgoFactory.eINSTANCE.createPerson()));
	}
