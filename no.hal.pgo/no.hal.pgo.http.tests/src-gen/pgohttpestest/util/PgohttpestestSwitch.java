 ...
 * @generated
 */
public class PgohttpestestSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PgohttpestestPackage.ROOT: {
				Root root = (Root)theEObject;
				T result = caseRoot(root);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PgohttpestestPackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PgohttpestestPackage.B: {
				B b = (B)theEObject;
				T result = caseB(b);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PgohttpestestPackage.C: {
				C c = (C)theEObject;
				T result = caseC(c);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PgohttpestestPackage.D: {
				D d = (D)theEObject;
				T result = caseD(d);
